...
if ( isset($_POST["ICHE_OUTACCTNO"]) ) $ICHE_OUTACCTNO 	= trim( $_POST["ICHE_OUTACCTNO"] );			//이체계좌번호
...
<style type="text/css">
<!--
body { font-family:"Malgun Gothic", "AppleGothic","돋움"; font-size:9pt; color:#000000;
	font-weight:normal; letter-spacing:0pt; line-height:240%; }
td { font-family:"Malgun Gothic", "AppleGothic","돋움"; font-size:9pt; color:#000000; font-weight:normal;
	letter-spacing:0pt; line-height:240%; }
...
.title { margin: .4em 0; font-size: 1.2em; font-weight: 100; }
-->
</style>
...
<table class="content" border=0 width=100% cellpadding=0 cellspacing=0>
	<tr>
		...
		<table width=400 border=0 cellpadding=0 cellspacing=0>
			...
			<tr>
				<td class=clsleft><div class="title">굿톡 화상영어 수업료 지불 결과</div></td>
			</tr>
			<tr>
				<td><hr></td>
			</tr>
...
<?				}
				if($AuthTy == "card" ) {?>
					<tr>
						...
						<!--영수증출력을위해서보내주는값-------------------->
						<td class=clsleft><input type="button" value="영수증 출력하기" onclick="javascript:show_receipt();"></td>
					</tr>
					<tr>
						<td colspan=2>&nbsp;</td>
					</tr>
